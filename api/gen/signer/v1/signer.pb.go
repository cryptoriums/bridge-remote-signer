...
const file_signer_v1_signer_proto_rawDesc = "" +
	...
	"\bchain_id\x18\x01 \x01(\tR\achainId2\xaf\x03\n" +
	"\fBridgeSigner\x127\n" +
...
var file_signer_v1_signer_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
...
var file_signer_v1_signer_proto_depIdxs = []int32{
	...
	10, // 5: signer.v1.BridgeSigner.GetChainID:input_type -> signer.v1.GetChainIDRequest
	1,  // 6: signer.v1.BridgeSigner.Sign:output_type -> signer.v1.SignResponse
	3,  // 7: signer.v1.BridgeSigner.GetPublicKey:output_type -> signer.v1.GetPublicKeyResponse
	5,  // 8: signer.v1.BridgeSigner.SignRaw:output_type -> signer.v1.SignRawResponse
	7,  // 9: signer.v1.BridgeSigner.GetAddress:output_type -> signer.v1.GetAddressResponse
	9,  // 10: signer.v1.BridgeSigner.SignTx:output_type -> signer.v1.SignTxResponse
	11, // 11: signer.v1.BridgeSigner.GetChainID:output_type -> signer.v1.GetChainIDResponse
