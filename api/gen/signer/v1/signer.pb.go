...
const file_signer_v1_signer_proto_rawDesc = "" +
	...
	"\n" +
	"public_key\x18\x01 \x01(\fR\tpublicKey2\x98\x01\n" +
	"\fBridgeSigner\x127\n" +
	"\x04Sign\x12\x16.signer.v1.SignRequest\x1a\x17.signer.v1.SignResponse\x12O\n" +
	"\fGetPublicKey\x12\x1e.signer.v1.GetPublicKeyRequest\x1a\x1f.signer.v1.GetPublicKeyResponseB?Z=github.com/tellor-io/bridge-signer/api/gen/signer/v1;signerv1b\x06proto3"
...
var file_signer_v1_signer_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_signer_v1_signer_proto_depIdxs = []int32{
	...
	1, // 2: signer.v1.BridgeSigner.Sign:output_type -> signer.v1.SignResponse
	3, // 3: signer.v1.BridgeSigner.GetPublicKey:output_type -> signer.v1.GetPublicKeyResponse
